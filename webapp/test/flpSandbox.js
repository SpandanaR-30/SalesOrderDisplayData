					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order ",
									"targetURL": "#salesorderdisplay-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"salesorderdisplay-display": {
								"semanticObject": "salesorderdisplay",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesorderdisplay",
									"url": sap.ui.require.toUrl("salesorderdisplay")
								}
							}
						}
					}
